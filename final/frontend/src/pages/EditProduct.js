...
class EditProduct extends React.Component {
    ...
    saveProduct(){
        ...
        fetch("http://localhost:8080/api/product/edit", requestOptions)
        .then(response => response.json())
        .then(result => {
            console.log(result);
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="card shadow mb-4">
                                    <div className="card-header py-3">
                                        <h6 className="m-0 font-weight-bold text-primary">Modifier un produit</h6>
                                    </div>
                                    <div className="card-body">
                                            ...
                                            <div className="mb-3">
                                                <label>Poids</label>
                                                <input className="form-control" value={ this.state.weight } type="number" onChange={ (e)=>{ this.setState({ weight:e.target.value }) } } />
                                            </div>
                                            <div className="mb-3">
                                            ...
                                            <div className="mb-3">
                                                <button className="btn btn-success" onClick={ ()=>{ this.saveProduct() } }>Modifier</button>
                                            </div>
